-- JobHunter AI Database Schema (Supabase version)
-- PostgreSQL 16 - pgvector will be enabled via Supabase dashboard

-- Enable extensions (uuid-ossp should already be available)
